...
void norm_binary_custom(string);
...
int main(int argc,char*argv[])
{
    ...
    cout<<"6-Convert customized binary file\n";
    cout<<"7-Read a converted binary file.\n";
...
void norm_binary_custom(string fname)
{
  string input_file = fname;
  string output_file_bin = fname + ".bin";
  ifstream in(input_file.c_str());
...
{
      string input_file = fname; //itree name 
